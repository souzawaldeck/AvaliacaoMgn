...
<div ng-controller="pessoasCtrl" class="container box">
            ...
            <div>
                <table class="table table-bordered table-striped">
                    <tr>
                        ...
                        <td>
                            <div align="right">
                                <a href="#" class="btn btn-primary btn-sm btn-info" ng-click="addTel(tel)"
                    ...
                    <tr ng-repeat="tell in tels">
                        <td>{{tell.tipo}}</td>
                        <td>{{tell.numero}}</td>
                        <td><div align="right"><button type="button" name="apagar" id="apagartudo" ng-click="DeletaTel(tell)" class="btn btn-primary btn-sm btn-danger">Excluir</button>  </div>   </td>
                    </tr>

                </table>
                <div>
                    <a href="#" class="btn btn-primary btn-sm btn-success" ng-click="AddPessoa(pessoa,tels)"
                       data-toggle="tooltip" ng-disabled="!pessoa.nome || !pessoa.cpf || !pessoa.rg" title="Adicionar Pessoa">Incluir</a>
